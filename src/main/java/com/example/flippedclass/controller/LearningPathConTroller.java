...
public class LearningPathController {
    ...
    public ResponseEntity<List<LearningPathResponse>> getLearningPath(@PathVariable Long spaceId) {
        return ResponseEntity.ok(learningPathService.getLearningPath(spaceId));
    }


    @GetMapping("/{pathId}")
    public ResponseEntity<LearningPathResponse> getDetail(@PathVariable Long spaceId, @PathVariable Long pathId) {
        return ResponseEntity.ok(learningPathService.getLearningPathDetail(spaceId, pathId));
    }
    ...
    public ResponseEntity<LearningPathResponse> update(@PathVariable Long spaceId, @PathVariable Long pathId, @Valid @RequestBody UpdateLearningPathRequest request) {
        return ResponseEntity.ok(learningPathService.updateLearningPath(spaceId, pathId, request));
    }
    ...
    public ResponseEntity<?> archive(@PathVariable Long spaceId, @PathVariable Long pathId) {
        ...
        return ResponseEntity.ok(new MessageResponse("Lưu trữ roadmap thành công"));
    }
